...
def compile_output_list(wildcards):
    output_files = {
        ...
        for path in [
            ...
            f"cnv_sv/purecn/{sample}.csv",
            f"cnv_sv/purecn/{sample}.rds",
            f"cnv_sv/purecn/{sample}_dnacopy.seg",
            f"cnv_sv/purecn/{sample}_chromosomes.pdf",
            f"cnv_sv/purecn/{sample}_segmentation.pdf",
            f"cnv_sv/purecn/{sample}_local_optima.pdf",
            f"cnv_sv/purecn/{sample}_loh.csv",
    }
